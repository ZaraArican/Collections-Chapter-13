...
break;
case 3://add to end///
System.out.println("Enter integer to end of the list");
newVal = scan.nextInt();
list.addToEnd(newVal);//list to new valueabl
break;
case 4://removes first
list.removeFirst();
break;
case 5://removes the last element of the list. If the list is empty, does nothing.
list.removeLast();
break;
case 6://removes certain number from list
...
System.out.println("4: Remove the first element of the list");
System.out.println("5: Remove the last element of the list");//
System.out.println("6: Remove certain number from list");//
